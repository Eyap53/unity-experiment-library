...
- **feat**: Add Simple log saver that save the player Log to participant folder.
- **feat**: Add Atom Log saver that save the player logs to participant folder base on atoms intReference.

### Tests

- **tests**: Add tests for the log savers.
